#pragma checksum "C:\Users\victo\Documents\CS 3750\TypingGameUpdated\Group1Remastered-main\Typing-G1\Typing\Pages\Game.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "2a8438b11f76a001d537b3d6b8e9016ba77a9870"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"2a8438b11f76a001d537b3d6b8e9016ba77a9870", @"/Pages/Game.cshtml")]
...
#nullable restore
#line 7 "C:\Users\victo\Documents\CS 3750\TypingGameUpdated\Group1Remastered-main\Typing-G1\Typing\Pages\Game.cshtml"
...
#nullable disable
        ...
        ");
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("form", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "2a8438b11f76a001d537b3d6b8e9016ba77a98705938", async() => {
    ...
    <div class=""right"" id=""p2"">
        ...
        ");
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("form", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "2a8438b11f76a001d537b3d6b8e9016ba77a98708266", async() => {
...
");
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("script", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "2a8438b11f76a001d537b3d6b8e9016ba77a987010272", async() => {
            }
            );
...
<script>
    var arr =
        [
            ...
            ""SWIM"", ""APPLE"", ""C");
            WriteLiteral(@"ARROT"", ""BOOK"", ""COIN"", ""CUPCAKE"", ""PENCIL"", ""BOAT"", ""FINGER"", ""DOOR""
        ];
</script>
...
<script>
            ...
            $('.wordBox').each(function () {
                ...
                if (string == substring) {
                    ...
                    if (p2count < 10) {
                        ...
                        $(th");
            WriteLiteral(@"is).animate({ left: (docWidth - 75) + 'px' }, 15000, 'linear', function () { gameOverP2(); });
                    } else if (p2count < 40) {
                        ...
                        $(this).a");
            WriteLiteral(@"nimate({ left: (docWidth - 75) + 'px' }, 8000, 'linear', function () { gameOverP2(); });
                    } else {
    ...
    $('#tb1').keyup(function () {
        var username = '");
#nullable restore
#line 151 "C:\Users\victo\Documents\CS 3750\TypingGameUpdated\Group1Remastered-main\Typing-G1\Typing\Pages\Game.cshtml"
                   Write(UserStatus.currentUser);
...
#nullable disable
    ...
    $('#startBtn').click(function () {
        ...
        if ($('#waiting').text() == 'Player Ready!') {
            ...
            var username = '");
#nullable restore
#line 167 "C:\Users\victo\Documents\CS 3750\TypingGameUpdated\Group1Remastered-main\Typing-G1\Typing\Pages\Game.cshtml"
                       Write(UserStatus.currentUser);
...
#nullable disable
    ...
    function sendStartMessage() {
        var username = '");
#nullable restore
#line 176 "C:\Users\victo\Documents\CS 3750\TypingGameUpdated\Group1Remastered-main\Typing-G1\Typing\Pages\Game.cshtml"
                   Write(UserStatus.currentUser);
    ...
    $('#tb1').keyup(function () {
        ...
        $('.wordBox1').each(function () {
            ...
            if (string == substring) {
                ...
                ");
            WriteLiteral(@"    $(this).animate({ left: (docWidth - 75) + 'px' }, 17000, 'linear', function () { gameOverP1(); });
                } else if (p1count < 30) {
            ...
            WriteLiteral(@", 9000, 'linear', function () { gameOverP1(); });
                } else if (p1count < 90) {
...
<style>
    ...
    .myButton:hover {
 ");
            WriteLiteral("       background-color: #476e9e;\n    }\n\n    .myButton:active {\n        position: relative;\n        top: 1px;\n    }\n</style>");
        }
