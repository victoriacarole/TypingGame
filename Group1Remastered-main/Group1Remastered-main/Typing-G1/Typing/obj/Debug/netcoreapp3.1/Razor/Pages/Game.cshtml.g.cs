#pragma checksum "C:\Users\Ian Brinkerhoff\OneDrive\Desktop\repo\TypingGame\Group1Remastered-main\Group1Remastered-main\Typing-G1\Typing\Pages\Game.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "dfa91cccbf61b278816116449b3eca08389495ab"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"dfa91cccbf61b278816116449b3eca08389495ab", @"/Pages/Game.cshtml")]
...
#nullable disable
        ...
        ");
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("form", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "dfa91cccbf61b278816116449b3eca08389495ab6047", async() => {
    ...
    <div class=""right"" id=""p2"">
        ...
        ");
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("form", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "dfa91cccbf61b278816116449b3eca08389495ab8391", async() => {
...
");
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("script", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "dfa91cccbf61b278816116449b3eca08389495ab10409", async() => {
            }
            );
...
<script>
    ...
    connecti");
            WriteLiteral(@"on.on(""ReceiveMessage"", function (username, input) {
        msg = input;
        if (msg == ""newGame"") {
            ...
            WriteLiteral(@"         var string = $(this).text();
                if (string == substring) {
                    ...
                    if (p2count < 10) {
                        ...
                        $(t");
            WriteLiteral(@"his).animate({ left: (docWidth - 75) + 'px' }, 15000, 'linear', function () { gameOverP2(); });
                    } else if (p2count < 40) {
    ...
    //Everytime the player presses a key a new substring is sent to t");
            WriteLiteral(@"he opponents game
    $('#tb1').keyup(function () {
        var username = currentUser;
...
<script>
    ...
    $('#tb1').keyup(function () {
        ...
        $('.wordBox1').each(function () {
            ...
            if (string == substring) {
                ...
                if (p1count < 10) {
                    $(this).a");
            WriteLiteral(@"nimate({ left: (docWidth - 75) + 'px' }, 20000, 'linear', function () { gameOverP1(); });
                } else if (p1count < 20) {
    ...
    fu");
            WriteLiteral(@"nction gameOverP1() {
